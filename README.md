У даному репозиторії ви можете знайти модулі "extract", "transform", "load" та їхній підсумок "ETL". Також вхідний файл "trades.csv" і вихідний "bronze_top_three.xlsx".
Модуль "zvitnist" із звітністю та файлом "bronze_top_three.xlsx", який є результатом його роботи + 2 графіки.
